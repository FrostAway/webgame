...
class trendify_themepacific_tabs_slide_widget extends WP_Widget {
  function trendify_themepacific_tabs_slide_widget() {
  $widget_ops = array('classname' => 'tpcrn_tabs_slide_widget','description' => __( 'Stylish Tabbed Widget to dispaly Popular and Recent Posts,tags', 'iz_theme' ));
  $this->WP_Widget('tpcrn-tabs-widget', __( 'ThemePacific : Tabbed Widget', 'iz_theme' ), $widget_ops);	
	}
...
<li class="disable"><a href="#"><?php _e('Phổ biến', 'iz_theme'); ?></a></li>
<li class="disable "><a href="#"><?php _e('Mới nhất', 'iz_theme'); ?></a></li>
<li class="disable "><a href="#"><?php _e('Thẻ Tags', 'iz_theme'); ?></a></li>
</ul> 
...
/**
	...
	function form( $instance ) {
		...
		<p><?php _e('To Show Recent Posts and Popular Posts in Stylish Tabbed Content Format','iz_theme'); ?></p>
		
		<p>
			<label for="<?php echo $this->get_field_id('getnumpost'); ?>"><?php _e('Number of Posts to Show:','iz_theme'); ?></label>
