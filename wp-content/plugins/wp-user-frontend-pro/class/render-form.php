    ...
    function textarea( $attr, $post_id, $type ) {
        ...
        <div class="wpuf-fields">
            ...
            if ( $attr['rich'] == 'yes' ) {
                ...
                wp_editor( $value, $attr['name'], array('editor_height' => $attr['rows'], 'quicktags' => true, 'media_buttons' => false, 'editor_class' => $req_class) );
                
            } elseif( $attr['rich'] == 'teeny' ) {
                
                printf( '<span class="wpuf-rich-validation" data-required="%s" data-type="rich" data-id="%s"></span>', $attr['required'], $attr['name'] );
                wp_editor( $value, $attr['name'], array('editor_height' => $attr['rows'], 'quicktags' => true, 'media_buttons' => false, 'teeny' => true, 'editor_class' => $req_class) );
            } else {
                ?>
